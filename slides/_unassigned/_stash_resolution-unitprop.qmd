---
title: "Stash — resolution, unit propagation, the pyodide implementation"
subtitle: "Displaced 2026-09-23. Superseded by lecture 7."
---

<!-- Lecture 7 now teaches unit propagation with a worksheet instead of the
     Main Mall Midnight card game. Kept here for the parts lecture 7 does not
     use: the Explore UBC six-variable puzzle, the working pyodide
     implementation, and the Horn/non-Horn discussion. -->
